...
@connect(({ brand, loading }) => ({ brand, loading: loading.models.brand }))
export default class Index extends PureComponent {
      ...
      render() {
            ...
            const { brand: { data, currentItem, modalVisible, modalType }, dispatch, loading } = this.props;
